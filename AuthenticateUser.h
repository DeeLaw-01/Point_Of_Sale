...
#include <fstream>
#include "windows.h" // Removes ISERVICEPROVIDER IS AMBIGIOUS error..
#include "MyForm.h"
#include <sstream>
#include <iostream>
#include <vector>
...
using namespace System; // Required to use System data types such as String^
using namespace System::IO;
using namespace System::Windows::Forms;
using namespace msclr::interop;

public ref class AuthenticateUser {
public:
    bool Login(String^ username, String^ password, bool user) ;
    bool Register(String^ username, String^ password);
    bool MatchesDatabase(String^ username, bool isAdmin);
